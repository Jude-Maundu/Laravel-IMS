...
<div class="db-container">
  ...
  <div class="itd-breadcrumb">
    ...
    <span class="itd-bc-sep">/</span>
    <span class="itd-bc-cur">Edit</span>
  </div>
  ...
  <div class="db-card">
    <div class="db-card-header">
      <h3 class="db-card-title">Edit User: {{ $user->name }}</h3>
    </div>
    <div class="db-card-content">
      <form action="{{ route('users.update', $user) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {{-- Password --}}
          <div>
            <label for="password" class="db-form-label">New Password (leave blank to keep current)</label>
            <input type="password" id="password" name="password"
                   class="db-form-input @error('password') border-red-300 @enderror">
            @error('password')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
          </div>
          ...
          <div>
            <label for="password_confirmation" class="db-form-label">Confirm New Password</label>
            <input type="password" id="password_confirmation" name="password_confirmation"
                   class="db-form-input @error('password_confirmation') border-red-300 @enderror">
        ...
        <div class="mt-6 flex items-center justify-end space-x-3">
          ...
          <button type="submit" class="db-btn-primary">Update User</button>
        </div>
      </form>
    </div>
  </div>
