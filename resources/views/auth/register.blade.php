        ...
        <div class="form-inner">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div style="margin-bottom:0.75rem;">
                    <label style="display:block; font-size:11px; text-transform:uppercase; color:#999; letter-spacing:0.1em; margin-bottom:6px;">Full Name</label>
                    <input type="text" name="name" value="{{ old('name') }}" required autofocus class="login-input" placeholder="e.g. John Doe">
                </div>
                ...
                <div style="margin-bottom:0.75rem;">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required class="login-input" placeholder="user@greyapple.co.ke">
                </div>
                ...
                <div style="margin-bottom:1.5rem;">
                    <label style="display:block; font-size:11px; text-transform:uppercase; color:#999; letter-spacing:0.1em; margin-bottom:6px;">Confirm Password</label>
                ...
                <button type="submit" id="signin-btn"
                  ...
                  <span id="signin-btn-text" style="letter-spacing:0.18em;">CREATE ACCOUNT</span>
                ...
                <div style="margin-top: 1.5rem; text-align: center;">
                    <span style="font-size:13px; color:#888;">Already have an account?</span>
                    <a href="{{ route('login') }}" style="font-size:13px; color:#CC0000; text-decoration:none; font-weight:600; margin-left:5px;">Sign In</a>
                </div>

                <div style="margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid #e0dcd8; text-align: center;">
                    <p style="font-size:12px; color:#a09890; margin-bottom: 8px;">Are you a customer looking to hire gear?</p>
                    <a href="{{ route('portal.book') }}" style="font-size:13px; color:#0f0f0f; text-decoration:none; font-weight:700; display: inline-flex; align-items: center; gap: 5px;">
                        Request a Booking 
